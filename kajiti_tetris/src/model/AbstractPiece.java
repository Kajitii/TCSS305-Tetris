...
public abstract class AbstractPiece implements MutablePiece, Cloneable {
  ...
  private Block my_block;

  /**
   * Creates a new piece at the given coordinates.
   * 
   * @param the_formation the rotational states for this Piece.
   ...
   */
  protected AbstractPiece(final int[][][] the_formation,
                          final int the_x,
                          final int the_y,
                          final Block the_block) {
    my_rotations = the_formation.clone();
    my_x = the_x;
    my_y = the_y;
   ...
   */
  @Override
  public final void moveUp() { //see MutablePiece
    my_y++;
  }
   ...
   */
  @Override
  public final void rotate(final boolean the_cc) { //edited
   ...
   */
  public final int[][] getFormation() { //Name changer and stuff
   ...
   */
  public final int[][] getBoardCoordinates() { //rewritten to reflect previous changes
  ...
  /**
   * Turns the piece into a ghost piece.
   */
  public void turnIntoGhostPiece() {
    my_block = Block.GHOST;
  }
